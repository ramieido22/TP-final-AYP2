...
Aeropuerto* crear_nuevo_aeropuerto(){
    ...
    cin >> codigo;
    cout << "Ingrese el nombre del aeropuerto(guion medio en vez de espacios): "<< endl;
    cin >> nombre;
    cout << "Ingrese la ciudad del aeropuerto(guion medio en vez de espacios): " << endl;
    cin >> ciudad;
    cout << "Ingrese el pais del aeropuerto(guion medio en vez de espacios): "<< endl;
    cin >> pais;
    cout << "Ingrese la superficie del aeropuerto: "<< endl;
    cin >> superficie;
    cout << "Ingrese la cantidad de terminales del aeropuerto: "<< endl;
    cin >> cantidad_terminales;
    cout << "Ingrese la cantidad de destinos nacionales del aeropuerto: "<< endl;
    cin >> destinos_nacionales;
    cout << "Ingrese la cantidad de destinos internacionales del aeropuerto: "<< endl;
